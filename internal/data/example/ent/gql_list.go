...
// List executes the query and returns totalCount and nodes []*Account.
func (a *AccountQuery) List(ctx context.Context, offset, limit int, opts ...AccountPaginateOption) (*AccountConnection, error) {
	pager, err := newAccountPager(opts, false)
	if err != nil {
		return nil, err
	}
