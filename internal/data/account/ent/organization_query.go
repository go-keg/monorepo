...
func (oq *OrganizationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Organization, error) {
	...
	for name, query := range oq.withNamedMemberships {
		if err := oq.loadMemberships(ctx, query, nodes,
			...
			func(n *Organization, e *Membership) { n.appendNamedMemberships(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (oq *OrganizationQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *Tenant)) error {
