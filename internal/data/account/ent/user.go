...
func (_m *User) NamedOauthAccounts(name string) ([]*OAuthAccount, error) {
	if _m.Edges.namedOauthAccounts == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedOauthAccounts[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *User) appendNamedOauthAccounts(name string, edges ...*OAuthAccount) {
	if _m.Edges.namedOauthAccounts == nil {
		_m.Edges.namedOauthAccounts = make(map[string][]*OAuthAccount)
	}
	if len(edges) == 0 {
		_m.Edges.namedOauthAccounts[name] = []*OAuthAccount{}
	} else {
		_m.Edges.namedOauthAccounts[name] = append(_m.Edges.namedOauthAccounts[name], edges...)
	}
}

// NamedTenantUsers returns the TenantUsers named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *User) NamedTenantUsers(name string) ([]*TenantUser, error) {
...
func (_m *User) appendNamedTenantUsers(name string, edges ...*TenantUser) {
	if _m.Edges.namedTenantUsers == nil {
