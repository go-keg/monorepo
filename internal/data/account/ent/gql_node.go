...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case membership.Table:
		...
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, membershipImplementors...); err != nil {
				return nil, err
			}
		}
		return query.Only(ctx)
	case oauthaccount.Table:
		query := c.OAuthAccount.Query().
			Where(oauthaccount.ID(id))
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, oauthaccountImplementors...); err != nil {
				return nil, err
			}
		}
		return query.Only(ctx)
	...
	case tenant.Table:
		...
		return query.Only(ctx)
	case tenantrole.Table:
		query := c.TenantRole.Query().
			Where(tenantrole.ID(id))
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, tenantroleImplementors...); err != nil {
				return nil, err
			}
		}
		return query.Only(ctx)
	case tenantuser.Table:
		query := c.TenantUser.Query().
			Where(tenantuser.ID(id))
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, tenantuserImplementors...); err != nil {
				return nil, err
			}
		}
		return query.Only(ctx)
...
func (c *Client) noders(ctx context.Context, table string, ids []int) ([]Noder, error) {
	...
	case membership.Table:
		...
		query, err := query.CollectFields(ctx, membershipImplementors...)
		if err != nil {
			return nil, err
		}
	...
	case oauthaccount.Table:
		query := c.OAuthAccount.Query().
			Where(oauthaccount.IDIn(ids...))
		query, err := query.CollectFields(ctx, oauthaccountImplementors...)
		if err != nil {
			return nil, err
		}
		nodes, err := query.All(ctx)
	...
	case tenantrole.Table:
		query := c.TenantRole.Query().
			Where(tenantrole.IDIn(ids...))
		query, err := query.CollectFields(ctx, tenantroleImplementors...)
		if err != nil {
			return nil, err
		}
		nodes, err := query.All(ctx)
	...
	case tenantuser.Table:
		query := c.TenantUser.Query().
			Where(tenantuser.IDIn(ids...))
		query, err := query.CollectFields(ctx, tenantuserImplementors...)
		if err != nil {
			return nil, err
		}
		nodes, err := query.All(ctx)
