...
func (u *OAuthAccountUpsert) ClearUpdatedAt() *OAuthAccountUpsert {
	u.SetNull(oauthaccount.FieldUpdatedAt)
	return u
}
...
// ClearUpdatedAt clears the value of the "updated_at" field.
func (u *OAuthAccountUpsertOne) ClearUpdatedAt() *OAuthAccountUpsertOne {
	return u.Update(func(s *OAuthAccountUpsert) {
		s.ClearUpdatedAt()
	})
}
...
// ClearUpdatedAt clears the value of the "updated_at" field.
func (u *OAuthAccountUpsertBulk) ClearUpdatedAt() *OAuthAccountUpsertBulk {
	return u.Update(func(s *OAuthAccountUpsert) {
		s.ClearUpdatedAt()
	})
}
